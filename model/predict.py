...
def predict(data):
    ...
    create_mask('raw_image.jpg', color)

    img = Image.open('raw_image.jpg')
    img2 = Image.open('mask_image.png')

    im_mask = Image.open('mask_image.png')
...
def create_mask(raw_image, color):
